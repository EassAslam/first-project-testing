...
const translations = {
  en: {
    ...
    galleryTitle: "A place for fresh cuts.",
    galleryCopy: "Placeholder tiles for now, ready for real haircut photos from the next shop shoot.",
    galleryFadeTitle: "Fade",
    galleryFadeCopy: "A clean tile for skin fades, tapers, and sharp blends.",
    galleryShapeTitle: "Shape Up",
    galleryShapeCopy: "A spot for crisp hairlines and quick edge cleanups.",
    galleryBeardTitle: "Beard Detail",
    galleryBeardCopy: "Room for beard work, line-ups, and finished profiles.",
    galleryClassicTitle: "Classic Cut",
    galleryClassicCopy: "A simple space for everyday cuts and clean finishes.",
    galleryKidsTitle: "Kids Cut",
    galleryKidsCopy: "A friendly tile for neat kids cuts and family visits.",
    galleryShopTitle: "Shop Detail",
    galleryShopCopy: "A place for tools, chairs, and behind-the-scenes moments.",
  ...
  es: {
    ...
    galleryTitle: "Un espacio para cortes frescos.",
    galleryCopy: "Cuadros temporales por ahora, listos para fotos reales en la proxima sesion.",
    galleryFadeTitle: "Fade",
    galleryFadeCopy: "Un espacio para skin fades, tapers y blends limpios.",
    galleryShapeTitle: "Cerquillo",
    galleryShapeCopy: "Un lugar para lineas definidas y limpiezas rapidas.",
    galleryBeardTitle: "Detalle de Barba",
    galleryBeardCopy: "Espacio para barba, line-ups y perfiles terminados.",
    galleryClassicTitle: "Corte Clasico",
    galleryClassicCopy: "Un espacio simple para cortes diarios y acabados limpios.",
    galleryKidsTitle: "Corte de Ninos",
    galleryKidsCopy: "Un cuadro amigable para cortes de ninos y visitas familiares.",
    galleryShopTitle: "Detalle de la Barberia",
    galleryShopCopy: "Un lugar para herramientas, sillas y momentos detras de escena.",
