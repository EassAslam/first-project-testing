...
const translations = {
  en: {
    ...
    galleryTitle: "A first look inside the shop.",
    galleryCopy: "Early photo selects from a quick visit, with room to upgrade the gallery after a proper shoot.",
    gallerySignAlt: "Sandy Barber Shop sign above the storefront",
    gallerySignTitle: "Storefront Sign",
    gallerySignCopy: "The street-facing sign gives the site a real neighborhood identity.",
    galleryEntranceAlt: "Front entrance and windows of Sandy Barber Shop",
    galleryEntranceTitle: "Front Entrance",
    galleryEntranceCopy: "A clear exterior shot helps customers recognize the shop before they arrive.",
    ...
    galleryWorkingAlt: "Barber working with a client in the chair",
    galleryWorkingTitle: "At Work",
    galleryWorkingCopy: "A working shot makes the page feel active and personal.",
    galleryCutAlt: "Close detail of a haircut being brushed and cleaned up",
    galleryCutTitle: "Cut Detail",
    galleryCutCopy: "Close-up haircut photos will be a strong upgrade after the final shoot.",
  ...
  es: {
    ...
    galleryTitle: "Una primera mirada dentro de la barberia.",
    galleryCopy: "Fotos iniciales de una visita rapida, con espacio para mejorar la galeria despues de una sesion formal.",
    gallerySignAlt: "Letrero de Sandy Barber Shop sobre la tienda",
    gallerySignTitle: "Letrero Exterior",
    gallerySignCopy: "El letrero de la calle le da al sitio una identidad real del vecindario.",
    galleryEntranceAlt: "Entrada y ventanas de Sandy Barber Shop",
    galleryEntranceTitle: "Entrada Principal",
    galleryEntranceCopy: "Una foto clara del exterior ayuda a los clientes a reconocer la barberia al llegar.",
    ...
    galleryWorkingAlt: "Barbero trabajando con un cliente en la silla",
    galleryWorkingTitle: "En Trabajo",
    galleryWorkingCopy: "Una foto trabajando hace que la pagina se sienta activa y personal.",
    galleryCutAlt: "Detalle de un corte siendo cepillado y limpiado",
    galleryCutTitle: "Detalle del Corte",
    galleryCutCopy: "Fotos de cerca de los cortes seran una mejora fuerte despues de la sesion final.",
