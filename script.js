...
const translations = {
  en: {
    ...
    cutsEyebrow: "Recent Cuts",
    cutsTitle: "Fresh work from the chair.",
    cutsCopy:
      "A small haircut gallery for fades, tapers, shape-ups, beard work, and everyday clean cuts. Replace the placeholders when the real photos are ready.",
    cutsGridAria: "Recent haircut examples",
    cutSkinFadeAlt: "Skin fade haircut placeholder",
    cutTaperAlt: "Taper haircut placeholder",
    cutShapeUpAlt: "Shape up haircut placeholder",
    cutBeardAlt: "Haircut with beard placeholder",
    cutKidsAlt: "Kids haircut placeholder",
    cutClassicAlt: "Classic haircut placeholder",
    cutSkinFadeTitle: "Skin Fade",
    cutTaperTitle: "Taper",
    cutShapeUpTitle: "Shape Up",
    cutBeardTitle: "Haircut + Beard",
    cutKidsTitle: "Kids Cut",
    cutClassicTitle: "Classic Cut",
    galleryEyebrow: "Gallery",
    galleryTitle: "A look around the shop.",
    galleryCopy: "Atmosphere shots that show the storefront, stations, tools, and neighborhood feel.",
  ...
  es: {
    ...
    cutsEyebrow: "Cortes Recientes",
    cutsTitle: "Trabajo fresco desde la silla.",
    cutsCopy:
      "Una pequena galeria de cortes para fades, tapers, cerquillos, barba y cortes limpios de todos los dias. Reemplaza los placeholders cuando las fotos reales esten listas.",
    cutsGridAria: "Ejemplos recientes de cortes",
    cutSkinFadeAlt: "Placeholder de corte skin fade",
    cutTaperAlt: "Placeholder de corte taper",
    cutShapeUpAlt: "Placeholder de cerquillo",
    cutBeardAlt: "Placeholder de corte con barba",
    cutKidsAlt: "Placeholder de corte de nino",
    cutClassicAlt: "Placeholder de corte clasico",
    cutSkinFadeTitle: "Skin Fade",
    cutTaperTitle: "Taper",
    cutShapeUpTitle: "Cerquillo",
    cutBeardTitle: "Corte + Barba",
    cutKidsTitle: "Corte de Nino",
    cutClassicTitle: "Corte Clasico",
    galleryEyebrow: "Galeria",
    galleryTitle: "Una mirada a la barberia.",
    galleryCopy: "Fotos del ambiente que muestran el exterior, las estaciones, herramientas y el estilo del vecindario.",
