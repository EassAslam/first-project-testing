...
const translations = {
  en: {
    ...
    serviceEyebrowsTitle: "Eyebrows",
    serviceEyebrowsCopy: "Quick eyebrow cleanup for a sharper finish.",
    serviceLinesTitle: "Lines",
    serviceLinesCopy: "Clean line detail for a crisp final touch.",
  ...
  es: {
    ...
    serviceEyebrowsTitle: "Cejas",
    serviceEyebrowsCopy: "Limpieza rapida de cejas para un acabado mas definido.",
    serviceLinesTitle: "Linea",
    serviceLinesCopy: "Detalle de linea limpio para un toque final preciso.",
